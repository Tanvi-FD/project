          ...
          <div className="container">
            ...
            <div className="row">
              ...
              <div className="col-lg-4 col-md-6">
                <div className="item">
                  <a href="property-details.html">
                    <img src="assets/images/property-02.jpg"  />
                  </a>
                  <span className="category">Luxury Villa</span>
                  <h6>$1.180.000</h6>
                  <h4>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="item">
                  <a href="property-details.html">
                    <img src="assets/images/property-03.jpg"  />
                  </a>
                  <span className="category">Luxury Villa</span>
                  <h6>$1.460.000</h6>
                  <h4>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="item">
                  <a href="property-details.html">
                    <img src="assets/images/property-04.jpg"  />
                  </a>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="item">
                  <a href="property-details.html">
                    <img src="assets/images/property-05.jpg"  />
                  </a>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="item">
                  <a href="property-details.html">
                    <img src="assets/images/property-06.jpg"  />
                  </a>
